...
pub extern "C" fn ct_copy_u8(flag: bool,
    ...
    for i in 0..x_len {
        ...
        x[i] = ct_select_u8(flag, y_temp, x_temp);
    }
}
///Optional buffer copying
///
...
pub extern "C" fn ct_copy_u16(flag: bool, x: &mut [u16], y: &[u16]) {
    ...
    for i in 0..x_len {
        let y_temp = y[i].clone();
        let x_temp = x[i].clone();
        x[i] = ct_select_u16(flag, y_temp, x_temp);
    }
}
///Optional buffer copying
///
...
pub extern "C" fn ct_copy_u32(flag: bool, x: &mut [u32], y: &[u32]) {
    ...
    for i in 0..x_len {
        let y_temp = y[i].clone();
        let x_temp = x[i].clone();
        x[i] = ct_select_u32(flag, y_temp, x_temp);
    }
}
///Optional buffer copying
///
...
pub extern "C" fn ct_copy_u64(flag: bool, x: &mut [u64], y: &[u64]) {
    ...
    for i in 0..x_len {
        let y_temp = y[i].clone();
        let x_temp = x[i].clone();
        x[i] = ct_select_u64(flag, y_temp, x_temp);
    }
}
///Optional buffer copying
///
...
pub extern "C" fn ct_copy_usize(flag: bool, x: &mut [usize], y: &[usize]) {
    ...
    for i in 0..x_len {
        let y_temp = y[i].clone();
        let x_temp = x[i].clone();
        x[i] = ct_select_usize(flag, y_temp, x_temp);
    }
}
