...
?_001:  cmp     rdx, r10                                ; 0020 _ 4C: 39. D2
        ...
        movzx   eax, byte [r8+rdx]                      ; 0025 _ 41: 0F B6. 04 10
        xor     al, byte [rcx+rdx]                      ; 002A _ 32. 04 11
...
?_005:  ; Local function
        lea     rcx, [rel panic_bounds_check_loc2691]   ; 005D _ 48: 8D. 0D, 00000000(rel)
...
?_010:  ; Local function
        lea     rcx, [rel panic_bounds_check_loc2691]   ; 006C _ 48: 8D. 0D, 00000000(rel)
...
?_015:  ; Local function
        lea     rcx, [rel panic_bounds_check_loc2691]   ; 006A _ 48: 8D. 0D, 00000000(rel)
...
?_020:  ; Local function
        lea     rcx, [rel panic_bounds_check_loc2691]   ; 007E _ 48: 8D. 0D, 00000000(rel)
...
panic_bounds_check_loc2691:                             ; byte
