...
?_006:  ; Local function
        lea     rcx, [rel panic_bounds_check_loc2725]   ; 0052 _ 48: 8D. 0D, 00000000(rel)
...
?_011:  ; Local function
        lea     rcx, [rel panic_bounds_check_loc2725]   ; 004D _ 48: 8D. 0D, 00000000(rel)
...
?_015:  ; Local function
        lea     rcx, [rel panic_bounds_check_loc2725]   ; 0049 _ 48: 8D. 0D, 00000000(rel)
...
?_020:  ; Local function
        lea     rcx, [rel panic_bounds_check_loc2725]   ; 004E _ 48: 8D. 0D, 00000000(rel)
...
?_028:  lea     rcx, [rel panic_bounds_check_loc2727]   ; 0063 _ 48: 8D. 0D, 00000000(rel)
...
?_032:  lea     rcx, [rel panic_bounds_check_loc2727]   ; 0064 _ 48: 8D. 0D, 00000000(rel)
...
?_036:  lea     rcx, [rel panic_bounds_check_loc2727]   ; 0061 _ 48: 8D. 0D, 00000000(rel)
...
?_040:  lea     rcx, [rel panic_bounds_check_loc2727]   ; 0062 _ 48: 8D. 0D, 00000000(rel)
...
?_044:  lea     rcx, [rel panic_bounds_check_loc2727]   ; 0062 _ 48: 8D. 0D, 00000000(rel)
        mov     rdx, rdi                                ; 0069 _ 48: 89. FA
        mov     r8, rsi                                 ; 006C _ 49: 89. F0
        call    _ZN4core9panicking18panic_bounds_check17h19e9bbc59320a57eE; 006F _ E8, 00000000(rel)
        ud2                                             ; 0074 _ 0F 0B
...
panic_bounds_check_loc2725:                             ; byte
        dq str2724                                      ; 0000 _ 0000000000000000 (d)
...
panic_bounds_check_loc2727:                             ; byte
        dq str2724                                      ; 0000 _ 0000000000000000 (d)
        dq 0000000000000006H                            ; 0008 _ 0000000000000006 
        dq 0000000000000127H                            ; 0010 _ 0000000000000127 
...
_ZN3lib10ct_copy_u814_MSG_FILE_LINE17h64c7ea2d2318bf7eE: ; byte
        dq str2730                                      ; 0000 _ 0000000000000000 (d)
        dq 0000000000000039H                            ; 0008 _ 0000000000000039 
        dq str2724                                      ; 0010 _ 0000000000000000 (d)
        dq 0000000000000006H                            ; 0018 _ 0000000000000006 
        dq 0000000000000143H                            ; 0020 _ 0000000000000143 
